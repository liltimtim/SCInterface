...
Pod::Spec.new do |s|
  s.name             = 'SCInterface'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SCInterface.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SCInterface'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Timothy Barrett' => 'liltimtim@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SCInterface.git', :tag => s.version.to_s }
